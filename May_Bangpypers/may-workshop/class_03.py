...
class Customer(Person):
	def __init__(self, first_name, age, email, last_name=None):
		super(Customer, self).__init__(first_name=first_name, age=age, last_name=last_name)
		self.email = email
...
def main():
    person = Person(first_name="Jai", last_name="D", age=24)
    #print person.first_name
    #print person.last_name
    #print person.get_age()
    #print person.is_major()

    customer = Customer(first_name="Jai", last_name="D", age=24, email="test@gmail.com")
    print customer.first_name, customer.last_name, customer.get_age(), customer.email
